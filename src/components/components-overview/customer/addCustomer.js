...
export default ({ memberships, refetch }) => {
  ...
  async function handleSubmit(event) {
    ...
    if (
      ...
      toast.info(
        "Down Payment should be equal to the ammount specified by the membership",
        {
          position: "top-center",
          autoClose: 3000,
    ...
    if (downpayment1date.value) {
      array.push({
        payment_date: downpayment1date.value,
        amount: +downpayment1amount.value,
      });
    }
    if (downpayment2date.value) {
      array.push({
        payment_date: downpayment2date.value,
        amount: +downpayment2amount.value,
      });
    }
    if (downpayment3date.value) {
      array.push({
        payment_date: downpayment3date.value,
        amount: +downpayment3amount.value,
      });
    }
    const body = {
      name: name.value,
                      ...
                      <td>
                        <FormGroup>
                          <div className="row">
                            ...
                            <div className="col-sm-6 col-md-6">
                              <label htmlFor={`downpayment1amount`}>
                                Amount
                              </label>
                              <FormInput
                                type="number"
                      ...
                      <td>
                        <FormGroup>
                          <div className="row">
                            ...
                            <div className="col-sm-6 col-md-6">
                              <label htmlFor={`downpayment2amount`}>
                                Amount
                              </label>
                              <FormInput
                                type="number"
                      ...
                      <td>
                        <FormGroup>
                          <div className="row">
                            ...
                            <div className="col-sm-6 col-md-6">
                              <label htmlFor={`downpayment3amount`}>
                                Amount
                              </label>
                              <FormInput
                                type="number"
