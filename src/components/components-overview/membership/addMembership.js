...
export default ({ refetch, rtl }) => {
  ...
  async function handleSubmit(event) {
    ...
    const body = {
      ...
      supervisor_commision: supervisor_commision.value
        ? supervisor_commision.value
        : null,
      employee_commision: employee_commision.value
        ? employee_commision.value
        : null,
    };
    await POST(
      URL2 + "membership",
              ...
              <li className="list-group-item p-3">
                <div className="row">
                  <div className="col-sm-12 col-md-6">
                    ...
                    <FormGroup>
                      <label htmlFor="#supervisor_commision">
                  ...
                  <div className="col-sm-12 col-md-6">
                    <FormGroup>
                      <label htmlFor="#lodgings">Lodgings per anum</label>
                      <FormInput
                        type="number"
                        id="#lodgings"
                    ...
                    <FormGroup>
                      <label htmlFor="#employee_commision">
                        Employee Commission
                      </label>
                      <FormInput
                        type="number"
