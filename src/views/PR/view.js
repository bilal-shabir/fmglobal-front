...
class PR_view extends React.Component{
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
              ...
              },
              {
                ...
                {row.uploaded_file ? (<Can I="read" a="/purchase-requisition/getPrAttachment/:id/</span>" ability={this.state.ability}><button onClick={()=>this.testFileGet(row.id) } type="submit"  style={{marginTop:'3px'}}>Attachment</button></Can>):
                (<Can I="read" a="/purchase-requisition/getPrAttachment/:id/</span>" ability={this.state.ability}><button onClick={()=>this.testFileGet(row.id) } disabled type="submit"  style={{marginTop:'3px'}}>Attachment</button></Can>)}
              ...
              {
                name: "Action",
                cell:(row)=> <span><Can I="read" a="/purchase-requisition/get-prid/:id/" ability={this.state.ability}><button type="button"  onClick={()=>this.editpr(row.id) }>View</button></Can></span>,
                sortable: true,
                center: true
              }
      ...
      async testFileGet(id){
        ...
        .catch((e) => {
          // console.log(e)  
          toast.error('Something went wrong, pdf not fetched', {
              position: "top-center",
              autoClose: 3000,
      ...
      async componentDidMount() {
        require('../../utils').checkpermision('List')
        ...
        await fetch(url, {
          ...
          this.setState({
            columns: [
              ...
              {
                name: "Action",
                cell:(row)=> <Can I="read" a="/purchase-requisition/get-prid/:id/" ability={this.state.ability}><button type="button" onClick={()=>this.editpr(row.id) }>View</button></Can>,
                // sortable: true,
                center  : true,
                width:'100px'
              }
      ...
      editpr =(id) => {
        ...
        fetch(URL2+'purchase-requisition/get-prid/'+id, {
          ...
          .then(response => {
            ...
            // console.log(e)  
            toast.error('Something went wrong, material requisition not retrieved', {
                position: "top-center",
                autoClose: 3000,
                hideProgressBar: false,
                closeOnClick: true,
      ...
      resetfilters = async() =>{
        ...
        if(this.state.data.length != 0){
          ...
          document.getElementById("pr_sort").selectedIndex = 0;
        }
      ...
      handlesubmit = async (id) => {
        ...
        const access_token = localStorage.getItem('access_token');
        await fetch(URL2+'purchase-requisition/updatePR', {
            headers : { 
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'access_token' : access_token
              ...
              <li class="list-group-item p-3">
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <strong class="text-muted d-block mb-2">Material Requisition Information</strong>
                    <form>
                      ...
                      <label style={{fontSize:'13px'}}>Delivery Date</label>
                        <input
                          ...
                          id="Delivery_Date"
                          defaultValue={this.convert(this.state.pr.delivery_date)}
                        />{" "}
                      </div>
                      {}
                    </form>
                      ...
                      <label style={{fontSize:'13px'}}>Status</label>
                        <div class="input-group mb-3">
                          {/* <input
                            ...
                            aria-label="Username"
                            aria-describedby="basic-addon1"
                            defaultValue={this.state.pr.Status}
                          />{" "} */
