...
class UserAssign extends React.Component {
  ...
  edit_handelSubmit = async (event) => {
    ...
    //var parameter_id = document.getElementById("edit_parameter").value;

    //var project_id = document.getElementById("edit_project").value;
    //var device_id = document.getElementById("edit_device").value;

    if (
      this.state.editRow.min_value === edit_min_value &&
      this.state.editRow.max_value === edit_max_value &&
      this.state.editRow.start_time === edit_start_time &&
      this.state.editRow.end_time === edit_end_time &&
      this.state.editRow.type === edit_type &&
      this.state.editRow.edit_is_email === edit_is_email &&
      this.state.editRow.is_signal === edit_is_signal &&
      this.state.editRow.is_null === edit_is_null
    ) {
  ...
  render() {
    ...
    return (
      <Container fluid className="main-content-container px-4">
        ...
        {/* ------- Assign NEW resource to role FORM -------- */}
        <span>
          <Modal
        ...
        <span>
          ...
          >
            ...
            <Modal.Footer>
              ...
              <Button
                variant="danger"
                onClick={this.deleteRow.bind(this, this.state.deleteRowid)}
              >
                Delete
              </Button>
            </Modal.Footer>
