...
class All_Invoices extends React.Component{
    constructor(props) {
        super(props);
      ...
      const type = localStorage.getItem('Type');
        ...
        //   alert(this.state.create_date_max)
          this.handleShowCreate = this.handleShowCreate.bind(this)
          
      }

      async componentDidMount() {
        require('../../utils').checkpermision('Invoices')
        ...
        //     create_date_max: create_date_max
        // })
        // console.log(this.state.create_date_max)
        ...
        // const inv_permission = permissions.find(({ resource }) => resource.name === 'Invoice' )
        // if(inv_permission.write == true){
        //     this.setState({
        //         inv_write : true
        //     })
        // }
        // console.log(inv_permission)
        this.getData() 
      }
      
    //   ?company_id='+this.state.comp_id+'&project_id='+this.state.proj_id+'&operation_approval='+this.state.opp_approval+'&finance_approval='+this.state.fin_approval+'&billing_month='+this.state.bill_month+'&status='+this.state.status_inv
      getData(){
        ...
        fetch(url, {
          ...
          .then((response) => {
            if (response.statusCode == 404 || response.statusCode == 401 || response.statusCode == 500 || response.statusCode == 400 || response.statusCode == 403) {
              ...
              this.setState({
                columnsInvoices: [
                    ...
                    {
                        name: <span>Customer Name <select id="customer" style={{width:'37px', borderRadius:'5px', fontSize:'10px', marginLeft:'3px', cursor:'pointer'}} onChange={this.projectfilter}>
                    ...
                    {
                        name: <span>Project Name <select id="p_name" style={{width:'37px', borderRadius:'5px', fontSize:'10px', marginLeft:'3px', cursor:'pointer'}} onChange={this.projectfilter}>
                        <option value='' disabled selected>Filter</option>
                    ...
                    {
                        name: <span>Operations Approval <select id="o_approval" style={{width:'37px', borderRadius:'5px', fontSize:'10px', marginLeft:'3px', cursor:'pointer'}} onChange={this.projectfilter}>
                        <option value='' disabled selected>Filter</option>
                        ...
                        selector: (row) => row.approved_by_operation ? (<span>&#x2714;</span>) : (<span>&#x274C;</span>),
                        center: true
                       
                    },
                    {
                        name: <span>Finance Approval <select id="f_approval" style={{width:'37px', borderRadius:'5px', fontSize:'10px', marginLeft:'3px', cursor:'pointer'}} onChange={this.projectfilter}>
                        <option value='' disabled selected>Filter</option>
                          <option key={true} value={true}>   
                              &#x2714;
                          </option>
                        ...
                        selector: (row) => row.approved_by_finance ? (<span>&#x2714;</span>) : (<span>&#x274C;</span>),
                        center: true
                       
                    },
                    {
                        name: <span>Billing Month<select id="b_month" style={{width:'37px', borderRadius:'5px', fontSize:'10px', marginLeft:'3px', cursor:'pointer'}} onChange={this.projectfilter}>
                        <option value='' disabled selected>Filter</option>
                    ...
                    {
                        name: <span>Status<select id="status" style={{width:'37px', borderRadius:'5px', fontSize:'10px', marginLeft:'3px', cursor:'pointer'}} onChange={this.projectfilter}>
                        <option value="" disabled selected>Filter</option>
                        <option key="new" value={1}>   
                                New
                        </option>
                        <option key="pending_approval" value={2}>   
                                Pending Approval
                        </option>
                        <option key="approved" value={6}>   
                                Approved
                        </option>  
                        <option key="billed" value={3}>   
                                Invoiced
                        </option>
                        ...
                        <option key="paid" value={7}>   
                                Paid
                        </option>                   
                      </select></span>,
                        selector: (row) => <span style={{padding:'10px'}}>{row.invoice_status.name}</span>,
                        center: true
                    ...
                    },
                    {
                        ...
                        selector: (row) => <Can I="read" a="/invoice/getInvoice/:id/" ability={this.state.ability}>  <button type="button"  onClick={()=>this.handleShow(row.id) }>View Details</button> </Can>,
                        center: true
                    }
          ...
          .catch((e) => {
            // console.log(e)  
            toast.warning('Something went wrong, invoices not retrieved', {
                position: "top-center",
                autoClose: 3000,
        ...
        fetch(URL2+'auth-customer-role/getCustomer', {
            ...
            .catch((e) => {
                // console.log(e)  
                toast.warning('Something went wrong, customers not retrieved', {
                    position: "top-center",
                    autoClose: 3000,
                    hideProgressBar: false,
                    closeOnClick: true,
      ...
      create_invoice= async()=>{
        ...
        const company_id = localStorage.getItem('company');  
         ...
         await fetch(URL2+'invoice/generateInvoice', {
            ...
            method: 'POST',
            mode: 'cors',
            body: JSON.stringify({ customer_id: this.state.customer_id, company_id: company_id, project_id: this.state.project_id, start_date: s_date, end_date: e_date  })
        }).then(response => response.json())
        .then((response)=>{
            if (response.statusCode == 404 || response.statusCode == 401 || response.statusCode == 500 || response.statusCode == 400 || response.statusCode == 403) { 
                throw Error(response.statusText)        
            ...
            // console.log(response)
                ...
                setTimeout(function(){ y.className = "hide" }, 6000);
                // After 3 seconds, remove the show class from DIV
                setTimeout(function(){ x.className = "show" }, 6000);
        ...
        .catch((e) => {
            // console.log(e)  
            toast.error('Something went wrong, invoice not created', {
                position: "top-center",
                autoClose: 3000,
                hideProgressBar: false,
                closeOnClick: true,
              ...
              this.setState({
                columnsInvoices: [
                    ...
                    },
                    {
                        ...
                        selector: (row) => <span class={row.invoice_status.name} style={{padding:'10px'}}>{row.invoice_status.name}</span>,
                        center: true
                    ...
                    {
                        name: <span>Actions</span>,
                        selector: (row) =>  <Can I="read" a="/invoice/getInvoice/:id/" ability={this.state.ability}>  <button  onClick={()=>this.handleShow(row.id) } >View Details</button> </Can>,
                        center: true
                    }
    ...
    projectfilter =() => {
        ...
        url.searchParams.append('customer_name', document.getElementById("customer").value);
        ...
        url.searchParams.append('billing_month', document.getElementById("b_month").value);
    ...
    requestapproval =(id)=>{
        alert(id)
        fetch(URL2+`invoice/requestApprovalForInvoice/${id}`,{
            headers : { 
              'Content-Type': 'application/json',
              'Accept': 'application/json',
             },
    ...
    updateStatus = async () =>{
        ...
        await fetch(URL2+`invoice/updateInvoicePaymentStatus`,{
            headers : { 
              'Content-Type': 'application/json',
              'Accept': 'application/json',
        ...
        return(
            ...
            <div class="card card-small mb-4" style={{marginTop:'15px'}}>
              ...
              <div  style={{display:'flex'}} class="  card-header border-bottom">
                <h5 style={{flex:'8'}} class="m-0 ">Invoices<span style={{fontSize:'9px', marginLeft:'5px', color:'blue', cursor:'pointer'}} onClick={this.resetfilters}>reset filters</span></h5>
                <button onClick={this.updateStatus} >Update Status</button>
                <Can I="write" a="/invoice/generateInvoice/" ability={this.state.ability}>
                <button onClick={this.handleShowCreate} style={{marginLeft:'5px'}} >Create</button>
                </Can>
            ...
            <span>
                ...
                >
                    ...
                    <button  onClick={()=>this.showbillingdata(this.state.invoice[0].id)} style={{marginRight:'5px'}}>
                     Billing Data
                    </button>
                    </Can>
                    ...
                    {this.state.invoice.map((invoice) => (
                         ...
                         <div class="row">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" class="form-control"  placeholder="" name="comp-address" id="comp-address"  defaultValue={invoice.customer.invoice_address_line_1} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Address Line 2</label>
                                 <input type="text" class="form-control"  placeholder="" name="comp-city" id="comp-city" defaultValue={invoice.customer.invoice_address_line_2} required disabled></input>
                             </div><div class="form-group">
                                 <label >Address Line 3</label>
                                 <input type="text" class="form-control"  placeholder="" name="comp-state" id="comp-state" defaultValue={invoice.customer.invoice_address_line_3} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Address Line 4</label>
                                 <input type="text" class="form-control"  placeholder="" name="comp-zip" id="comp-zip" defaultValue={invoice.customer.invoice_address_line_4} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Address Line 5</label>
                                 <input type="text" class="form-control"  placeholder="" name="comp-zip" id="comp-zip" defaultValue={invoice.customer.invoice_address_line_5} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Address Line 6</label>
                                 <input type="text" class="form-control"  placeholder="" name="comp-zip" id="comp-zip" defaultValue={invoice.customer.invoice_address_line_6} required disabled></input>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="date" class="form-control"  placeholder="Enter start date" name="INV-start-date" id="INV-start-date" defaultValue={this.abc2(invoice.start_date)} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Invoice End Date</label>
                                 <input type="date" class="form-control"  placeholder="Enter end date" name="INV-end-date" id="INV-end-date" defaultValue={this.abc2(invoice.end_date)} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Payment Due Date</label>
                                 <input type="date" class="form-control"  placeholder="Enter due date" name="INV-due-date" id="INV-due-date" defaultValue={this.abc2(invoice.due_date)} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Billing Month</label>
                                 <input type="text" class="form-control"  placeholder="Invoice Billing Month" name="INV-billing-month" id="INV-billing-month" defaultValue={invoice.billing_month} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Total Power Generated</label>
                                 <input type="number" class="form-control"  placeholder="enter power generated" name="INV-power-generated" id="INV-power-generated"defaultValue={parseFloat(invoice.production_generated).toFixed(3)} disabled required step="0.00001"></input>
                             </div>
                             <div class="form-group">
                                 <label >Sub Total</label>
                                 <input type="number" class="form-control"  placeholder="enter Sub Total" name="INV-sub-total" id="INV-sub-total" defaultValue={parseFloat(invoice.sub_total).toFixed(3)} required step="0.00001" disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Tax Rate</label>
                                 <input type="number" class="form-control"  placeholder="enter tax rate" name="INV-tax-rate" id="INV-tax-rate" defaultValue={parseFloat(invoice.tax_rate).toFixed(3)} required disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Tax</label>
                                 <input type="number" class="form-control"  placeholder="enter tax" name="INV-tax" id="INV-tax" defaultValue={parseFloat(invoice.tax).toFixed(3)} required step="0.00001" disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Total Amount</label>
                                 <input type="number" class="form-control"  placeholder="enter total Amount" name="INV-total-amount" id="INV-total-amount" defaultValue={parseFloat(invoice.total).toFixed(3)} required step="0.00001" disabled></input>
                             </div>
                             <div class="form-group">
                                 <label >Previous Month Dues</label>
                                 <input type="number" class="form-control"  placeholder="enter total Amount" name="INVC_PREVIOUS_DUES" id="INVC_PREVIOUS_DUES" defaultValue={parseFloat(invoice.previous_dues).toFixed(3)} required step="0.00001" disabled></input>
                             </div>
                    ...
                    {this.state.devices.map((device) => (
                        ...
                        <Col>
                                ...
                                <input type="text" class="form-control"  placeholder="enter device ID" name="did1" id={"did"+device.id} defaultValue={device.device.sn} disabled required ></input>
                            </Col>
                            <Col>
                                <label for="exampleInputPassword1">Device Description</label>
                                <input type="text" class="form-control"  placeholder="enter description" name="desc1" id={"desc"+device.id} defaultValue={device.device.desc} required disabled></input>
                            </Col>
                        ...
                        <Col>
                                ...
                                <input type="number" class="form-control"  placeholder="enter power generated" name="pgen1" id={"pgen"+device.id} defaultValue={parseFloat(device.production_generated).toFixed(3)} required step="0.001" disabled></input>
                            </Col>
                            <Col>
                                <label for="exampleInputPassword1">Device Amount</label>
                                <input type="number" class="form-control"  placeholder="enter power generated" name="amn1" id={"amn"+device.id} defaultValue={parseFloat(device.amount).toFixed(3)} required step="0.001" disabled></input>
                            </Col>
                ...
                >
                        ...
                        <Row>
                            <Col>
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control"  placeholder="Enter start date" name="INV-start-date" id="INV_start_date"required onChange={this.invoicestartdate}></input>
                                </div>
                            </Col>
                            <Col>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Invoice End Date</label>
                                    <input type="date" class="form-control"  placeholder="Enter start date" name="INV-end-date" id="INV_end_date"required max={this.state.create_date_max} min={this.state.create_date_min}  ></input>
                                </div>
                            </Col>
                        </Row>
                        </span>
                    ...
                    <button  onClick={this.create_invoice} id="createinvoice">
                        Create
                    </button>
                    </Modal.Footer>
                ...
                >
                    ...
                    <span>
                    <Can I="read" a="/invoice-production/getInvoiceProduction/:id/" ability={this.state.ability}>
                    <ExcelFile filename="Billing Data" element={(<button > Download Report </button>)}>
                        <ExcelSheet data={this.state.billingData} name="Data">
                            <ExcelColumn label="Invoice Number" value="invoice_invc_number"/>
                            <ExcelColumn label="Customer" value="invoice_project_customer_name"/>
                            <ExcelColumn label="Project" value="invoice_project_name"/>
                            ...
                            <ExcelColumn label="Production Generated (kWh)"  value={row => +parseFloat(row.production_generated).toFixed(5)}/>
                        </ExcelSheet>
                    </ExcelFile>
                    </Can>
                    <button onClick={this.billingdataclose} style={{marginLeft:'5px'}}>
                        Close
                    </button>
                    </span>
                    </Modal.Header>
                ...
                >
                    <Modal.Body>
                        <div style={{textAlign:'center',marginTop:'30px'}}  id="not_generated"><h4>Generating Invoice</h4></div>
